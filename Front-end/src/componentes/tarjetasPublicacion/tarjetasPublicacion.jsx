...
function TarjetasPublicacion({api,index,key}) {
  const id=index
  console.log(id)
...
--------ESTO TODAVIA NO FUNCIONA :((((
 ...
 return (
   <div className={style.contenedor}>
        ...
        {api === undefined ? 'espera': <h3  key={id}>{api.user.nickname} <br/>
        ...
        {api === undefined ? 'espera': <h4 key={id}>{api.problem}
        </h4>}
        </div>
        <div className={style.reporteBoton}>
        <svg className={style.reporteBotonIcono} xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 16 16">
  <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12.435 12.435 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A19.626 19.626 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a19.587 19.587 0 0 0 1.349-.476l.019-.007.004-.002h.001"/>
        ...
        {api === undefined ? 'espera': <h3  key={id}>{api.createdAt}
        </h3>}
        </div>
        
        <div className={style.ubicacionPublicacion}>
        {api === undefined ? 'espera': <h3  key={id}>{api.location}, {api.neighborhood}
        </h3>}
        </div>

        <div className={style.apoyoPublicacion}>
        {api === undefined ? 'espera': <h5><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 0 0 8a8 8 0 0 0 16 0zm-7.5 3.5a.5.5 0 0 1-1 0V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707V11.5z"/>
</svg> {api.support}   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
  <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793V2zm5 4a1 1 0 1 0-2 0 1 1 0 0 0 2 0zm4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
        ...
        <svg className={style.botonComentariosIcono} xmlns="http://www.w3.org/2000/svg"  fill="white"  viewBox="0 0 16 16">
