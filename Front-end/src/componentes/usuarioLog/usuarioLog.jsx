            ...
            <div className={`contenedor ${style.navLog}`}>
                ...
                <div className={`contenedor ${style.cont_Right}`}>
                    <ul className={`contenedor ${style.listaBoton}`}>
                        ...
                        <li className={style.li}><Link className={style.a} to="https://midenuncia-database-production.up.railway.app/logout"> <FaUserCircle className={style.iconsLog} /> </Link></li>
                    </ul>
                </div>
            </div>
