...
doc.fontSize(12).text('E. S. D.', { 
  ...
  .fontSize(12)
  .text('mayor de edad, vecino de esta ciudad, identificado con cédula de ciudadanía número 1.098.741.421 expedida en Bucaramanga, me permito instaurar en nombre propio ante su despacho este Derecho de Petición, con fundamento en los siguientes:', {
 ...
 doc .fontSize(12).text("\n")
  ...
  doc.fontSize(16).text('PRIMERO: ', { continued: true})
  .fontSize(12).text('Para el mes de Julio del año en curso me acerque a las instalaciones de BANCOLOMBIA sucursal las palmas de Bucaramanga para adquirir una cuenta bancaria...');
  ...
  doc.fontSize(16).text('PRIMERO: ', { continued: true})
  .fontSize(12).text('Hacer efectiva la solicitud de cancelación de seguro ');
...
doc.text('La petición que elevo mediante este escrito se fundamenta en las razones de hecho y de derecho anteriormente expuestas, que se dejan debidamente comprobadas con los siguientes anexos y documentos:', { 
  align: 'justify', 
  fontSize: 12, 
}).text('\n');
...
doc.text('Para la resolución favorable de mi petición, solicito tener como pruebas los anexos que relacioné antes y practicar, en caso de que lo encuentre viable cualquier otro medio de prueba que, a su juicio, sea necesario para la resolución favorable de mi petición.', { 
  align: 'justify', 
  fontSize: 12, 
}).text('\n');

doc.fontSize(16)
   .text('Fotos de la petición', {
     align: 'justify',
     lineGap: 12
   });
...
doc.image(imageBuffer, { width: 300 });*/
  ...
  doc.fontSize(12).text('Recibiré notificaciones personales preferiblemente en la Calle 43 # 7-57 Edificio Palermo 2 Apartamento 508, Barrio Alfonso López, Bucaramanga y al correo electrónico ', { align: 'justify', continued:true })
 .fontSize(16).text('ing.andresleon@hotmail.com', { link: 'ing.andresleon@hotmail.com',  color: 'blue', underline: false })
